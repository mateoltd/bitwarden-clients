...
| Semantic theme tokens     | [`libs/components/src/theme.css`](../libs/components/src/theme.css), [`semantic-tokens.css`](../libs/components/src/semantic-tokens.css), [`tailwind.config.base.js`](../libs/components/tailwind.config.base.js) | Token names and semantic roles are shared. App Tailwind configs add app source paths, not a separate token system.                                             |
...
- [`libs/components/src/theme.css`](../libs/components/src/theme.css) owns semantic CSS variables for
  light and dark themes. [`libs/components/src/semantic-tokens.css`](../libs/components/src/semantic-tokens.css)
